# koral-zig — validation log & milestones

This is the detailed, milestone-by-milestone record of what was implemented and
how each piece was validated against the C KORAL reference. It is the "lab
notebook" companion to the top-level [`README.md`](../README.md) (which links
here) and to the three onboarding documents in [`docs/`](README.md). If you want
the *why* behind the architecture see [`ARCHITECTURE.md`](ARCHITECTURE.md); for
the physics derivations see [`PHYSICS.md`](PHYSICS.md).
