// ZIGOT (PROBLEM 201) — 2D SR Orszag–Tang for koral-zig M6 step tests +
// flux_ct / calc_BfromA goldens. 32², MINK, periodic, B from vector
// potential (VECPOTGIVEN), PPM + RK2IMEX + LAXF.
